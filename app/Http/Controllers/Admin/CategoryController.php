...
//            'attribute_is_filter_ids.*' => 'attributes,id',
...
//        ]);
        ...
        try {
            ...
            DB::rollBack();
            alert()->error('مشکل در ایجاد دسته بندی', $exception->getMessage())->persistent('حله');
    ...
    public function update(Request $request, Category $category)
    {
        ...
        $request->validate([
            ...
            'parent_id' => 'required',
            'attribute_ids' => 'required',
            'attribute_ids.*' => 'exits:attributes,id',
            'attribute_is_filter_ids' => 'required',
            'attribute_is_filter_ids.*' => 'exits:attributes,id',
