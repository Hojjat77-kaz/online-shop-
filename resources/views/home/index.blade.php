        ...
        $('.variation-select').on('change',function(){
           ...
           variationPrice.empty();
            ...
            if(variation.is_sale){
             ...
             variationPrice.append(spanSale);
             variationPrice.append(spanPrice);
            }else{
                let spanPrice = $('<span />',{
                    class : 'new',
                    text : toPersianNum(number_format(variation.price)) + ' تومان'
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                                <div class="slider-single-img slider-animated-1">
                                    ...
                                    <img class="animated" src="{{asset(env('BANNER_IMAGES_UPLOAD_PATH').$slider->image)}}" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="banner-area pt-100 pb-65">
        <div class="container">
            <div class="row">
                ...
                @foreach($bannersTopIndex->chunk(3)->first() as $bannerTopIndex)
                    <div class="col-lg-4 col-md-4">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="{{$bannerTopIndex->button_link}}">
                                <img class="animated" src="{{asset(env('BANNER_IMAGES_UPLOAD_PATH').$bannerTopIndex->image)}}"
                                                                alt="{{$bannerTopIndex->image}}" /></a>
                            <div class="banner-content-2 banner-position-5">
                                <h4>{{$bannerTopIndex->title}}</h4>
                            </div>
                        </div>
                    </div>
                @endforeach

                @foreach($bannersTopIndex->chunk(3)->last() as $banner)
                            ...
                            <div class="ht-product-inner">
                                <div class="ht-product-image-wrap">
                                    <a href="{{ route('home.products.show' , ['product' => $product->slug]) }}" class="ht-product-image">
                                        <img src="{{asset(env('PRODUCT_IMAGES_UPLOAD_PATH').$product->primary_image)}}" alt="{{$product->primary_image}}" />
                                    </a>
                ...
                <div class="col-lg-10 ml-auto mr-auto">
                    <div class="testimonial-active owl-carousel nav-style-1">
                        <div class="single-testimonial text-center">
                            <img src="{{asset('images/home/testi-1.png')}}" alt="testi-1.png" />
                            <p>
                            ...
                            <div class="client-info">
                                <img src="{{asset('images/home/testi.png')}}" alt="image" />
                                <h5>لورم ایپسوم</h5>
                            </div>
                        </div>
                        <div class="single-testimonial text-center">
                            <img src="{{asset('images/home/testi-2.png')}}" alt="testi-2.png" />
                            <p>
                                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان
                                گرافیک است. چاپگرها و
                                متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی
    ...
    <div class="banner-area pb-120">
        <div class="container">
            <div class="row">
                ...
                @foreach($bannersBottomIndex as $banner)

                    <div class="col-lg-6 col-md-6 text-right">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="{{$banner->button_link}}">
                                <img src="{{asset(env('BANNER_IMAGES_UPLOAD_PATH').$banner->image)}}" alt="{{$banner->image}}" /></a>
                            <div class="{{ $loop->first ? 'banner-content banner-position-3' : 'banner-content banner-position-4' }}">
                                <h3>{{$banner->title}}</h3>
                                <h2>{{$banner->text}}</h2>
                                <a href="{{$banner->button_link}}">{{$banner->button_text}}</a>
                            </div>
